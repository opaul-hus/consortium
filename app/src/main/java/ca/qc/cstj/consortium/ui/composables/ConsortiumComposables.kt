...
import ca.qc.cstj.consortium.ui.screens.NewDeliveryScreen.NewDeliveryScreenViewModel

@Composable
fun InventoryItemCard(element:String,@DrawableRes symbol:Int,quantity:Float,viewModel: NewDeliveryScreenViewModel,slider:Float) {
...
fun DeliveryItemCard(del:Delivery){
    Card ( colors = CardDefaults.cardColors(
        ...
        modifier = Modifier
            ...
            Row (modifier = Modifier.fillMaxWidth().align(Alignment.CenterHorizontally).padding(start = 8.dp, end = 8.dp), horizontalArrangement = Arrangement.SpaceBetween) {
                Column {
